      ...
      {visiblePages.map((page, key) => {
        ...
        return (
          ...
          key={key}
            ...
            className={`px-3 py-2 text-sm font-medium rounded-lg ${isCurrentPage ? "bg-purple-600 text-whtie" : "text-gray-700 hover-bg-gray-100 bg-white border border-gray-300"}`}
          >
            {pageNumber}
          </Link>
        );
